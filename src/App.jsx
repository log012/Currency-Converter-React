...
import useCurrencyInfo from './hooks/useCurrencyInfo'
 ...
 const  handleToConvert=(e)=>{
      setConvertedAmount(amount*currencyInfo[to]);
 }
  return (
    <>
       <div className=' h-screen w-full flex flex-wrap justify-center items-center bg-cover bg-fixed bg-no-repeat' style={{backgroundImage:"url('https://images.pexels.com/photos/2105416/pexels-photo-2105416.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')"}}>
